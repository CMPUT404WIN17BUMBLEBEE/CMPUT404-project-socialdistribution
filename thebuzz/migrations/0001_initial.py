    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('github', models.CharField(default=b'', max_length=200, blank=True)),
                ('firstName', models.CharField(default=b'', max_length=200, blank=True)),
                ('lastName', models.CharField(default=b'', max_length=200, blank=True)),
                ('email', models.CharField(default=b'', max_length=400, blank=True)),
                ('bio', models.CharField(default=b'', max_length=2000, blank=True)),
                ('host', models.URLField()),
                ('url', models.URLField()),
